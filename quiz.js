...
buttonEle.addEventListener("click", function () {
  window.location.assign(`http://127.0.0.1:5501/score.html?score=${score}&ques=${totalQues}`);     
  // "http://127.0.0.1:5501/score.html?score=" + score + "&ques" = totalQues;
...
//   var opt = ques.answers;
//   opt.forEach((ans, ind) => {
//     div2.innerHTML += `<input id="${index + 1}" class="${ques.id}" type="radio" name="${ques.id}" >
//     <label for="${ques.id}">${ans}</label></br>`;
//   });
//   divEl.appendChild(div2);
// });

// var classes = document.getElementsByName("1001")
// console.log(classes);
// classes[0].addEventListener('click', (e) => { console.log(e.target.id)});
// // function valid(e){
